...
export default function Page() {
  return (
    <main className="space-y-8 mb-44">
      ...
      <div>
        <h2 className="mb-4 text-lg font-mono">Indicator</h2>
        {/* <hr className="mb-4 border-gray-200 dark:border-gray-800" /> */}
        <Separator />
        <div className="flex space-x-8">
          <FinancialIndicator type="Income" amount={1000} prevAmount={900} />
          <FinancialIndicator
            type="Expense"
            amount={12000}
            prevAmount={10000}
          ...
          <FinancialIndicator
            ...
            prevAmount={11100}
          />
          <FinancialIndicator type="Saving" amount={500} prevAmount={950} />
        </div>
      </div>
